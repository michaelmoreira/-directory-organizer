...
#3. Pegar a extenção do arquivo para determinar o tipo
#4. Mover arquivos para as pastas correspondentes


audios_ext = ['.mp3', '.wav']
videos_ext = ['.mp4', '.mov', '.avi']
imagens_ext = ['.jpg', '.jpeg', '.png', '.svg', '.eps', '.psd', '.cdr', '.ai']
documentos_ext = ['.txt', '.log', '.pdf', '.doc', '.docx', '.ppt']
...
def organizar(diretorio):
    ...
    for arquivo in nomes_arquivos:
        if os.path.isfile(os.path.join(diretorio, arquivo)):
            #extensao do arquivo com caixa baixa
